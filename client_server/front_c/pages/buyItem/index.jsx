        ...
        <Stack flex={1} ml="5" direction="row" p={4}>
          ...
          <Flex direction="column">
            ...
            <Box w="40rem" flex={2} pl="0.5rem" pt="1rem" borderBottom="1px solid rgba(0, 0, 0, 0.1);">
              ...
              <Button w="15rem" colorScheme="blue" variant="outline" ml="24rem" mt="0.5rem" mb="1rem" onClick={buyItem} disabled={formattedPrice <= point ? false : true}>
                구매
              </Button>
              ...
              <Flex>
                <Center pt="0.5rem" flex={1}>
                  <Flex direction="column">
                    ...
                    <Button w="5rem" colorScheme="blue" variant="outline" m="0 auto" mt="0.5rem" mb="0.5rem">
                      구매
                    </Button>
                  </Flex>
                </Center>
