...
>>>>>>> a1b2962d69af42853de24e9553d7079165e8821a
...
=======
    ...
    const getUserInfo = async () => {
        //hashId값으로 요청
        const response = await axios.post('http://localhost:8000/api/oauth/searchUser', { hashId: hashId })
    ...
    const updateUser = async () => {
        ...
        const response = await axios.post('http://localhost:8000/api/oauth/upDateUser', body)
            ...
            <Box w='40%' m='0 5%' h='20rem' pt='5rem'>
                ...
                {pwCheck === false ?
                    <>
                        <Center>
                            <Box w='100%'>
                                <Text textAlign={'center'} fontSize={'200%'} mb='2rem'> 회원정보</Text>
                            </Box>
                        ...
                        <Divider />
                        <Text fontSize={'130%'} mt='2rem' mb='1rem'> 비밀번호 입력</Text>
                        <Input type='password' placeholder='패스워드를 입력해주세요' id='password' size='md' onChange={setPwdCheckfunction} />


                        <Center>
                            <Button colorScheme='yellow' mb='2rem' variant='outline' mt='2rem' onClick={checkPwdfunction}> 확인</Button>
                        </Center>
                    </> :
                    ...
                    <>
                        <FormControl mt='3'>
                            <Text fontSize={'180%'} px='35%' >회원정보수정</Text>
                            <FormLabel fontSize={'140%'} px='2%' mb='3%'>
                                이메일
                            </FormLabel>
                            <Flex justifyContent={'center'} >
                        ...
                        <Center>
                            <Button colorScheme='yellow' mb='2rem' variant='outline' onClick={updateUser}>변경하기</Button>
                        </Center>
                        <Divider />

                        <Text fontSize={'180%'} px='35%' pt='4rem'>비밀 번호 수정</Text>
                        ...
                        <Input type='password' placeholder='패스워드를 입력해주세요' id='password' size='md' />
                        <Center>
                            <Button colorScheme='yellow' mb='2rem' mt='2rem' variant='outline' >변경하기</Button>
                        </Center>


                        <Divider />
                        <Text fontSize={'180%'} px='35%' pt='4rem' textAlign={'center'}> 회원 탈퇴 </Text>

                        <Center>
                            <Button colorScheme='yellow' mb='2rem' variant='outline' mt='2rem' onClick={deleteUser}> 회원탈퇴버튼</Button>
                        </Center>
                    </>
                }
            </Box>
